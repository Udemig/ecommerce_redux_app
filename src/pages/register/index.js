                ...
                <div className="box-body">
                  <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-6 col-xs-12 mb20">
                      ...
                      <p>
                        Please fill all Resgister form Fields Below.
                      </p>
                    </div>
                    ...
                    <form>
                      ...
                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div className="form-group">
                          ...
                          <input id="phone" name="phone" type="text" className="form-control" placeholder=" Number"
                                 required />
                        </div>
                      </div>
                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div className="form-group">
                          ...
                          <input id="email" name="emaol" type="text" className="form-control"
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                      ...
                      <div className="social-media">
                        <a href="#" className="btn-social-rectangle btn-facebook"><i className="fa fa-facebook"></i><span
                          className="social-text">Facebook</span></a>
                        ...
                        <a href="#" className="btn-social-rectangle btn-googleplus"><i
                          ...
                          className="social-text">Google Plus</span></a>
                      </div>
                    </div>
                  </div>
                </div>
