                        ...
                        <td>
                          <div className="product-quantity">
                            <div className="quantity">
                              <input type="number" className="input-text qty text" step="1" min="1" max="6" name="quantity"
                                     value="1" title="Qty" size="4" pattern="[0-9]*" />
                            </div>
                          </div>
                        </td>
                        <td>$1100.00</td>
                        <th scope="row"><a href="#" className="btn-close"><i className="fa fa-times-circle-o"></i></a></th>
                      </tr>
                      <tr>
                ...
                <div className=" table-responsive">
                  <div className="pay-amount ">
                    <table className="table mb20">
                      ...
                      <tr>
                        <th>
                          <span className="mb0" style="font-weight: 700;">Amount Payable</span></th>
              ...
              <div className="box-body">
                <form>
                  <div className="coupon-form">
                    <input type="text" name="coupon_code" className="form-control" id="coupon_code" value=""
                           placeholder="Coupon code" />
                    <input type="submit" className="btn btn-primary btn-block" name="apply_coupon" value="Apply coupon" />
                  </div>
                </form>
              </div>
            </div>
