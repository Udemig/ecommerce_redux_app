      ...
      <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
        <div id="cssmenu">
          <ul>
            ...
            <li className="has-sub"><a href="#">Brand (07)</a>
              <ul>
                <li>
                  <label>
                    <input type="checkbox" />
            ...
            <li className="has-sub"><a href="#">Price</a>
              <ul>
                <li>
                  <label>
                    <input type="checkbox" />
            ...
            <li className="has-sub"><a href="#">Screen Size</a>
              <ul>
                <li>
                  <label>
                    <input type="checkbox" />
            ...
            <li className="has-sub"><a href="#">PROCESSOR CORES</a>
              <ul>
                <li>
                  <label>
                    <input type="checkbox" />
            ...
            <li className="has-sub"><a href="#">FEATURES</a>
              <ul>
                <li>
                  <label>
                    <input type="checkbox" />
                    <span className="checkbox-list">3G Support</span></label>
                </li>
                <li>
                  <label>
                    <input type="checkbox" />
                    <span className="checkbox-list">4G Support</span></label>
                </li>
                <li>
                  <label>
                    <input type="checkbox" />
                    <span className="checkbox-list">Duel Camera</span></label>
                </li>
                <li>
                  <label>
                    <input type="checkbox" />
                    <span className="checkbox-list">Expandable Memory</span></label>
                </li>
                <li>
                  <label>
                    <input type="checkbox" />
                    <span className="checkbox-list">FM Radio</span></label>
                </li>
              </ul>
            </li>
          </ul>
